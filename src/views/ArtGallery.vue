  ...
  <div class="art-gallery">
    ...
    <div class="text-box">
      <div class="text-title-container">
        <h3 class="text-title">Virtual Art Exhibition</h3>
      </div>
      <p class="text">Virtual Art Exhibition is an online platform art gallery. A virtual showcase of arts made by all vocationer students in Brawijaya University. All arts are collected and provided inside our online virtual art gallery. Check out all the creativities by entering our brand new virtual art project.</p>
      <main-button text="Enter Art Exhibition"></main-button>
    </div>
...
.art-gallery {
  ...
  .background {
    ...
    background-image: url("../assets/img/home/art-gallery.jpg");
    background-size: 100%;
    transform: scale(1.5);
    filter: blur(50px);
