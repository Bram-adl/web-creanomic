  ...
  <div class="menu-container">
    ...
    <div class="menu-item menu-item-first">
      <router-link class="menu-link" to="home">
        <span @click.prevent="loadHomePage">{{ $t('home') }}</span>
      </router-link>
    </div>
    <div class="menu-item">
      <router-link class="menu-link" to="virtual-art-exhibition">{{ $t('virtualArtGallery') }}</router-link>
    </div>
    <div class="menu-item">
      <router-link class="menu-link" to="webinar">{{ $t('webinar') }}</router-link>
    </div>
    <div class="menu-item">
      <router-link class="menu-link" to="competition">{{ $t('competition') }}</router-link>
    </div>
    <div class="box box-footer">
        <small>&copy;Creanomic, <br> <a href="https://www.ub.ac.id" target="__blank">Universitas Brawijaya</a></small>
        <div class="wrapper">
          <a target="_blank" href="https://twitter.com/creanomic_ub">
          ...
          <a target="_blank" href="https://www.instagram.com/creanomic_vokasiub">
